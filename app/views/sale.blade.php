...
<div class="container">
	<div class="page-header">
  		<h1>Houses available for Sale. <small><i>live the dream</i></small></h1>
	</div>
	<div class="row">
          ...
          <div class="thumbnail">
              ...
              <div class="caption">
                ...
                <p>Cras justo odio, dapibus ac facilisis in,egestas eget quam.
                  ...
                  <a href="./sale_prop_detail1" > More Details >> </a> </p>
                <p><button type="button" class="btn btn-danger" disabled="disabled">For Sale</button></p>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-md-4">
          <div class="thumbnail">
              ...
              <div class="caption">
                ...
                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam.
                  Donec id elit non mi porta gravida at eget metus. 
                  <a href="./sale_prop_detail4" > More Details >> </a> </p>
                <p><p><button type="button" class="btn btn-danger" disabled="disabled">For Sale</button></p></p>
              </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4">
          <div class="thumbnail">
              ...
              <div class="caption">
                ...
                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam.
                  Donec id elit non mi porta gravida at eget metus. 
                  <a href="./sale_prop_detail5" > More Details >> </a> </p>
                <p><p><button type="button" class="btn btn-danger" disabled="disabled">For Sale</button></p></p>
              </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4">
          <div class="thumbnail">
              ...
              <div class="caption">
                ...
                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam.
                  Donec id elit non mi porta gravida at eget metus.<a href="./sale_prop_detail6" > More Details >> </a> 
                </p>
