    ...
    <div class="col-md-8" role="main">
      <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="col-md-12">
                  <div class="thumbnail">
                      <img src="img/one.jpg" alt=" " class="pull-left">
                      <div class="caption">
                  ...
                  <div class="thumbnail">
                      <img src="img/3.jpg" alt=" " class="pull-left">
                      <div class="caption">
                        <h3 class="text-center">NO 1B,Juwata Area C Dodoma</h3>
                        <p class="text-center">Cras justo odio, dapibus ac facilisis in, egestas eget quam.
                          Donec id elit non mi porta gravida at eget metus. 
