            ...
            <div class="well well-sm">
                @if(Session::has('errors'))
                    <div class='alert alert-warning'>
                        @foreach(Session::get('errors')->all() as $error_message)<p>{{$error_message}}</p>
                        @endforeach </div>
                @endif
                <form id="ContactForm" method="post" class="form-horizontal" action="{{URL::to('/contact') }}">
                    <fieldset>
                        <legend class="text-center header">Contact us</legend>

                            <div class="form-group">
                                <div class="col-md-10 col-md-offset-1">
                                	<label for="fullname"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>  Full Name</label>
                                    <input id="fullname" name="fullname" type="text" placeholder="John Doe" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-10 col-md-offset-1">
                                	<label for="msg"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>  Message</label>
                                    <textarea class="form-control" id="msg" name="msg" placeholder="Enter your massage for us here. We will get back to you within 2 business days." rows="7"></textarea>
                                </div>
                            </div>
